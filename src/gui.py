...
start_img = pygame.image.load("assets/start_blue.png").convert_alpha()
end_image = pygame.image.load("assets/exit_blue.png").convert_alpha()
start1_img = pygame.image.load("assets/start_purple.png").convert_alpha()
end1_img = pygame.image.load("assets/exit_purple.png").convert_alpha()
...
ai_b = NewButton(220, 452, ai_button, ai_button1)
